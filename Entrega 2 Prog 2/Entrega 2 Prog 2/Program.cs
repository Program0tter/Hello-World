...
namespace Entrega_2_Prog_2
{
    class Program
    {
        ...
        private void listarCargosConSueldoMayorDeMonto(int montoIngresado)
        {
            List<Cargo> listaCargos = miEmpresa.devolverListaCargos();
            int index = 0;
            foreach (Cargo cargo in listaCargos)
        ...
        private void listarCargosDependiendoDeSueldo()
        {
        ...
        private void crearMenu()
        {
            ...
            } while (opcionElegida < 1 && opcionElegida > 6 && salir == false);
